...
import static com.weelfly.common.util.JsonUtils.jsonToType;
import static com.weelfly.common.util.JsonUtils.toFilterJson;
...
public class ResponseEntityAspect {
    ...
    @Around("execution(org.springframework.http.ResponseEntity com.weelfly.*.controller.*Controller.*(..)) )")
