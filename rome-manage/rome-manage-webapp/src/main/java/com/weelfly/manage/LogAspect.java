...
import com.weelfly.common.util.CollectionProUtils;
...
import com.weelfly.manage.bean.domain.enums.NoticeType;
...
public class LogAspect {
    ...
    @Around(value = "@annotation(com.weelfly.common.annotation.Log)")
