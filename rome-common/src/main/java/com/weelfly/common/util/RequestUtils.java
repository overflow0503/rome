...
public abstract class RequestUtils {
     ...
     * 得到请求地址
     *
     * @return 如果是在http://www.google.com域名下请求当前服务器某个api,比如:http://www.rome.com/api,<p>
     * 那么获取到的就是http://www.google.com这个地址,而不是http://www.rome.com/api
     */
    ...
    /**
     * 得到请求参数 username=[shenshuangqing]
     *
     * @param request
     * @return
     * @throws IOException
