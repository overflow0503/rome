...
import com.weelfly.common.converter.StringToDateConverter;
import com.weelfly.common.filter.RequestLoggingFilter;
import com.weelfly.common.interceptor.InjectionAttackInterceptor;
...
public class SpringConfig implements WebMvcConfigurer, ErrorPageRegistrar {
    ...
    @ConditionalOnProperty(prefix = "rome.filter.injection-attack-interceptor", name = "enabled", havingValue = "true")
